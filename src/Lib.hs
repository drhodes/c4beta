...
--cseq rp xs = liftM DL.unzip $ mapM (compile rp) xs
...
instance Compile (CStatement NodeInfo) where
  ...
  compile _ (CReturn Nothing info) = done $ docs "TODO: return void"
  compile _ (CReturn (Just expr) a) = done $ docs "TODO: retrurn a value"
